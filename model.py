...
class Model(object):
    ...
    def __init__(self, data_config):
        ...
        self.ua_embeddings_4, self.ia_embeddings_4, self.ea_embeddings_4 = self.all_embeddings[self.n_layers - 1] # last layer
...
if __name__ == '__main__':
    ...
    left, norm_3, norm_4, norm_5, all_norm_3, all_norm_4, all_norm_5, = data_generator.get_adj_mat() # 3, 4 mean that the matrix with different normalization weight.
    ...
    for epoch in range(epoch):
        ...
        *********************************************************
        ...
        if int(hr[9] > max_hr_10) +  int(ndcg[9] > max_ndcg_10) + int(hr[4] > max_hr_5) + int(ndcg[4] > max_ndcg_5) + int(hr[19] > max_hr_20) + int(ndcg[19] > max_ndcg_20)> 3:
            ...
            # max_hr, max_ndcg, max_epoch = hr[9], ndcg[9], epoch
