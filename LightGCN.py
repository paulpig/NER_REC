...
class Model(object):
    ...
    def __init__(self, data_config):
        ...
        # self.all_embeddings = [self._create_norm_embed_norm()] #(user+item, dim), reduce_sum after l2 normalization. 效果不佳;
        
        # self.ua_embeddings_4, self.ia_embeddings_4 = self.all_embeddings[self.n_layers - 1] # last layer
        self.ua_embeddings_4, self.ia_embeddings_4 = tf.split(self.all_embeddings[-1], [self.n_users, self.n_items], 0) # sum layer, add normalizaton
        ...
        self.loss, self.mf_loss, self.emb_loss = self.create_bpr_loss_single_obj()
