...
class Model(object):
    ...
    def __init__(self, data_config):
        ...
        self.all_norm_adj = data_config['all_norm_adj'] # (item, user + entities)
        ...
        self.ua_embeddings_4, self.ia_embeddings_4 = tf.split(self.all_embeddings, [self.n_users, self.n_items], 0) # sum layer
        ...
        # self.ua_embeddings_4, self.ia_embeddings_4, self.ea_embeddings_4 = self.all_embeddings_all[self.n_layers - 1] # last layer
...
if __name__ == '__main__':
    ...
    norm, norm_entity = data_generator.get_adj_mat() # 3, 4 mean that the matrix with different normalization weight.
