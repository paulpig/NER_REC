...
class Data(object):
    ...
    def create_adj_mat(self):
            ...
            adj_mat_all[:self.n_users, self.n_users: self.n_users + self.n_items] = R # user-item
            adj_mat_all[self.n_users: self.n_users + self.n_items, :self.n_users] = R.T

            adj_mat_all[self.n_users: self.n_users + self.n_items, self.n_users + self.n_items:] = all_R # item-entity
            adj_mat_all[self.n_users + self.n_items:, self.n_users: self.n_users + self.n_items] = all_R.T

            adj_mat_senti[:self.n_users, self.n_users: self.n_users + self.n_items] = R_senti # user-item, dense matrix
            adj_mat_senti[self.n_users: self.n_users + self.n_items, :self.n_users] = R_senti.T

            adj_mat_all_senti[:self.n_users, self.n_users: self.n_users + self.n_items] = R_senti #(user, item)
